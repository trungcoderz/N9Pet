...
<footer class="main-footer text-sm">
        <strong>Nhóm 9 Bán thú cưng <?php echo date('Y') ?>. 
        <!-- <a href=""></a> -->
        </strong>
        Thú cưng vip xịn xò
        <div class="float-right d-none d-sm-inline-block">
          <b><?php echo $_settings->info('short_name') ?> (by: <a href="mailto:oretnom23@gmail.com" target="blank">N9</a> )</b>
        </div>
      </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          ...
          <li data-range-key="Last 7 Days">7 ngày cuối cùng</li>
          <li data-range-key="Last 30 Days">30 ngày cuối cùng</li>
          <li data-range-key="This Month">Tháng này</li>
          <li data-range-key="Last Month">Tháng trước</li>
          <li data-range-key="Custom Range">Tùy chọn</li>
        </ul>
      </div>
    ...
    <div class="jqvmap-label" style="display: none; left: 1093.83px; top: 394.361px;">N9</div>