...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Cập nhật sản phẩm ": "Tạo mới sản phẩm " ?>trong kho</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="size" class="control-label">Kích cỡ hoặc độ tuổi của pet</label>
