	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Tên Logan</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">Thông tin về chúng tôi</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Chính sách</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Website vipro by: </label>
				<div class="custom-file">
