...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Tạo mới " ?> Loại sản phẩm</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="category" class="control-label">Tên loại</label>
            ...
            <div class="form-group">
                ...
                <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Còn hàng</option>
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Hết hàng</option>
                </select>
			</div>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=maintenance/category">Hủy</a>
	</div>
</div>
<script>
