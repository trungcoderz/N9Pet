...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Tạo gói</h3>
	</div>
	<div class="card-body">
		<form action="" id="package-form">
            ...
            <div class="form-group">
				<label for="tour_location" class="control-label">Địa điểm</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=responses">Hủy</a>
	</div>
</div>
<script>
