    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Xóa hết các đơn hàng</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                <h3><b>Danh sách giỏ hàng</b></h3>
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Kích thước:</b> <?php echo $row['size'] ?></small></p>
                                <p class="mb-1 mb-sm-1"><small><b>Giá:</b> <span class="price"><?php echo number_format($row['price']) ?></span></small></p>
                                <div>
                ...
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h4>Tổng tiền:</h4></div>
                    <div class="col d-flex justify-content-end"><h4 id="grand-total">-</h4></div>
                </div>
            </div>
        </div>
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn btn-sm btn-flat btn-dark">Thanh toán</a>
        </div>
    </div>
</section>
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Bạn có chắc muốn xóa tất cả các đơn hàng không",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Bạn muốn bỏ sản phẩm này?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>