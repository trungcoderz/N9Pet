    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                 <span id="price"><?php echo $inv[0]['price'] ?> VND</span>
                <br>
                <span><small><b>Số lượng còn lại:</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status=='success'){
                        alert_toast("Thêm vào giỏ hàng thành công.",'success')
