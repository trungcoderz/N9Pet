...
Class Master extends DBConnection {
	...
	function save_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Tạo mới loại thành công.");
			else
	...
	function delete_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Xóa loại sản phẩm thành công.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_sub_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Tạo mới thuộc loại sản phẩm thành công.");
			else
				$this->settings->set_flashdata('success',"Cập nhật thành công.");
		}else{
			$resp['status'] = 'failed';
	...
	function delete_sub_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Xóa Thuộc loại sản phẩm thành công.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_product(){
		...
		if($save){
			...
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Tạo sản phẩm mới thành công.");
			else
				$this->settings->set_flashdata('success',"Cập nhật thành công.");
		}else{
			$resp['status'] = 'failed';
	...
	function delete_product(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Sản phẩm đã bị xóa.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_inventory(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Đã thêm sản phẩm vào kho.");
			else
				$this->settings->set_flashdata('success',"Cập nhật thành công.");
		}else{
			$resp['status'] = 'failed';
	...
	function delete_inventory(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Đã xóa sản phẩm khỏi kho.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function register(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Đã tạo tài khoản thành công.");
			else
				$this->settings->set_flashdata('success',"Đã cập nhật tài khoản.");
			foreach($_POST as $k =>$v){
	...
	function delete_order(){
		...
		if($delete){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Đơn hàng này đã bị xóa");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function update_order_status(){
		...
		if($update){
			$resp['status'] ='success';
			$this->settings->set_flashdata("success"," Cập nhật trạng thái đơn hàng thành công.");
		}else{
			$resp['status'] ='failed';
	...
	function pay_order(){
		...
		if($update){
			$resp['status'] ='success';
			$this->settings->set_flashdata("success"," Tình trạng thanh toán đơn hàng được cập nhật thành công.");
		}else{
			$resp['status'] ='failed';
			$resp['err'] =$this->conn->error;
		}
